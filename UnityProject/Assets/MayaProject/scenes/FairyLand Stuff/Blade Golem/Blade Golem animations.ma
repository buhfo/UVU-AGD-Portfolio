...
//Last modified: Mon, Apr 27, 2026 02:16:22 PM
//Codeset: 1252
...
fileInfo "UUID" "4287E6FF-40F4-35FD-0F47-50BA41313C81";
createNode transform -s -n "persp";
	rename -uid "C5EDEEC8-477E-5B16-21A8-94B68E51755A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.2966838975235628 8.1302015858244019 17.555205362242962 ;
	setAttr ".r" -type "double3" -378.3383526843632 -1099.7999999996932 -8.4510035341473757e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "92FF90B9-48FA-C64E-BBBA-B09A8DD15B08";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.306958843649312;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "11AFFB8A-4A3C-D80B-56F1-78B70D204A55";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A55391E1-4CED-038F-6728-5C9D250718EB";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "ECEF7A48-4A1E-24BD-0E9B-DAA110E72471";
createNode displayLayerManager -n "layerManager";
	rename -uid "5BEC69C5-45F7-7882-5AA7-C98C84553C97";
createNode displayLayer -n "defaultLayer";
	rename -uid "62E2DD04-4C60-20AA-8689-A9947C0C8844";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BD016F4B-40C9-8995-75DD-96AB186A6B44";
