...
//Last modified: Wed, Aug 26, 2026 10:57:27 PM
//Codeset: 1252
...
fileInfo "UUID" "85FB9F1A-46F0-B1F6-52F3-699217D6F8BB";
createNode transform -s -n "persp";
	rename -uid "F5CEBB08-4CAB-B0E9-C630-74B04981193B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 605.36895843653576 545.66638325343445 1485.8140425713912 ;
	setAttr ".r" -type "double3" -6.599999999916129 381.20000000018655 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 10;
	setAttr ".coi" 1659.7669696133389;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 105.81458670196933 379.95391908632217 1074.8665224939709 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "9511BEDA-4AD6-ED97-4068-90A69E7ACF97";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1072.9117991358166;
	setAttr ".ow" 1096.2663214142722;
...
createNode joint -n "L_leg_01_FK_jnt" -p "L_leg_clav_FK_jnt";
	...
	setAttr -k on ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 5.4597839609473517e-18 2.6816197531952588e-16 7.9203265993476252e-17 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
...
createNode joint -n "R_finger_01_knuckle_01_FK_jnt" -p "R_hand_01_FK_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 13.510201667392971 2.8697678185064084 0.35783197365631886 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
...
createNode joint -n "R_finger_02_knuckle_01_FK_jnt" -p "R_hand_01_FK_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 10.15481596021824 0.27084843733558117 6.7267651114763094 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
createNode joint -n "R_finger_02_knuckle_02_FK_jnt" -p "R_finger_02_knuckle_01_FK_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" -2.9822037947648838 1.1409210635516451 9.081938993150894 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
createNode joint -n "R_finger_02_knuckle_03_FK_jnt" -p "R_finger_02_knuckle_02_FK_jnt";
	...
	setAttr -k on ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -1.8061708538738439 5.2906194618162184e-16 -6.239196335760087e-17 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
...
createNode joint -n "R_finger_03_knuckle_03_FK_jnt" -p "R_finger_03_knuckle_02_FK_jnt";
	...
	setAttr -k on ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 5.1850632640674688 1.005247673922569e-15 2.6153579795379418e-16 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
createNode joint -n "R_finger_04_knuckle_01_FK_jnt" -p "R_hand_01_FK_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" -2.7959496724144333 -14.046053341364901 11.377323729375442 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
...
createNode fosterParent -n "Human_LowPolyRNfosterParent1";
	rename -uid "4DACC21C-400D-6BDD-36AF-BFA6162E776F";
