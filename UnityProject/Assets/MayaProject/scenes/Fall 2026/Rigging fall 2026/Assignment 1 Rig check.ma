...
//Last modified: Wed, Aug 26, 2026 09:46:05 PM
//Codeset: 1252
...
fileInfo "UUID" "F86ED02A-4714-3313-C622-0F801662F131";
createNode transform -s -n "persp";
	rename -uid "F5CEBB08-4CAB-B0E9-C630-74B04981193B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 262.34199050537995 1225.1031547406071 62.260853320389757 ;
	setAttr ".r" -type "double3" -85.200000000004209 9.999999999999897 -8.0740496602896054e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 10;
	setAttr ".coi" 665.36092933311045;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 130.77608449139504 594.96981568373417 1074.8665224939709 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "9511BEDA-4AD6-ED97-4068-90A69E7ACF97";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1072.9117991358166;
	setAttr ".ow" 494.0737982840671;
...
createNode joint -n "L_hand_01_jnt";
	...
	setAttr ".t" -type "double3" 293.67843627929693 597.97302246093716 -24.41645431518571 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 11.323249795368548 -47.166019599585113 -9.689335490320568 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_thumb_01_knuckle_jnt" -p "L_hand_01_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" -6.2086470637406919 47.888483069530785 1.9740699135270681 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_thumb_02_knuckle_jnt" -p "L_thumb_01_knuckle_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" -9.2155627977901649 -24.779347072014072 -14.920211166190221 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_thumb_03_knuckle_jnt" -p "L_thumb_02_knuckle_jnt";
	...
	setAttr ".t" -type "double3" 17.269747659559012 -1.302971645886871e-15 -1.3090611705072318e-13 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 80.817423276915648 48.444405428326981 77.810114450350142 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_finger_01_knuckle_01_jnt" -p "L_hand_01_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 139.56859374999755 60.177010606856925 -170.79794225469934 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_finger_01_knuckle_02_jnt" -p "L_finger_01_knuckle_01_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 29.079121930965659 12.258764964937136 -0.6253373064051353 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
...
createNode joint -n "L_finger_02_knuckle_03_jnt" -p "L_finger_02_knuckle_02_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 60.065393366480997 21.332414629111984 2.7823948015848288 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_finger_03_knuckle_01_jnt" -p "L_hand_01_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 149.57579173133962 29.210293919612671 -168.73132552543635 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_finger_03_knuckle_02_jnt" -p "L_finger_03_knuckle_01_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 128.66660029992488 6.8806334969529512 171.87789864315025 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_finger_03_knuckle_03_jnt" -p "L_finger_03_knuckle_02_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" -7.3514238488743384 -0.84502889482587096 4.137927840329823 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_finger_04_knuckle_01_jnt" -p "L_hand_01_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" -29.104116101367133 58.587325842909138 -22.56934541606547 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_finger_04_knuckle_02_jnt" -p "L_finger_04_knuckle_01_jnt";
	...
	setAttr ".t" -type "double3" 9.6774739998000125 -6.2790878412678241e-14 2.3029530656183879e-14 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" 4.7787666021228796 -66.683446307899501 -4.3900876662197827 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_finger_04_knuckle_03_jnt" -p "L_finger_04_knuckle_02_jnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jo" -type "double3" -4.1462031745364962 -0.046613496096524536 -1.1155544591818913 ;
	setAttr -k on ".jox";
	setAttr -k on ".joy";
	setAttr -k on ".joz";
	setAttr ".radi" 2;
createNode joint -n "L_clav_jnt";
	rename -uid "B24B79DB-4562-188B-7D96-259892D1731D";
	setAttr ".t" -type "double3" 2.6425345759918457 611.25480696445061 -27.770223617553732 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr -k on ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
...
createNode fosterParent -n "Human_LowPolyRNfosterParent1";
	rename -uid "B8946C69-4A0B-39B6-0D55-669D070ED84A";
