...
//Last modified: Mon, Dec 01, 2025 02:30:55 PM
//Codeset: 1252
...
fileInfo "UUID" "E2571E99-44CB-0B80-3F38-24BA676A4932";
createNode transform -s -n "persp";
	rename -uid "D96B7DC3-4E87-00B2-9FEE-AE9CF93A36AA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 26.94601825760537 10.143604860147898 15.831634170524435 ;
	setAttr ".r" -type "double3" -10.200000000000159 57.400000000000631 1.4758385058977616e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 30.373115142949136;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2BF6C379-411D-35EE-0BA4-988ABA9B1222";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "87745BE4-40E3-B6F3-07DB-24BF5ACBEBD0";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FD5AAF4C-486B-A6E4-82C4-6BA2D9DCD125";
createNode displayLayerManager -n "layerManager";
	rename -uid "F144C4D4-4C8E-11AA-074C-C3979C28F61D";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "13368F1B-4D1D-0300-AB5F-7395FB24246B";
