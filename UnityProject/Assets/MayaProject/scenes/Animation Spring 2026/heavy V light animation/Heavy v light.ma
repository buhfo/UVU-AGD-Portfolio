...
//Last modified: Sun, Feb 15, 2026 08:16:18 PM
//Codeset: 1252
...
fileInfo "UUID" "9EB0C047-48A6-753A-E19D-8B8A7F0CF6FE";
...
createNode mesh -n "polySurfaceShape1" -p "Ramp";
	...
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 144 ".uvst[0].uvsp[0:143]" -type "float2" 0 0 0.1 0 0.2 0 0.30000001
		 ...
		 0.69999999 0.80000001 0.69999999 0.80000001 0.80000001 0.80000001 0.30000001 0.80000001
		 0.25 0.80000001 0.40000001 0.80000001 0.30000001 0.80000001 0.5 0.80000001 0.40000001
		 0.80000001 0.60000002 0.80000001 0.5 0.80000001 0.69999999 0.80000001 0.60000002
	...
	setAttr -s 108 -ch 430 ".fc[0:107]" -type "polyFaces" 
		...
		f 4 59 216 -218 -216
		mu 0 4 132 122 133 121
		f 4 79 218 -220 -217
		mu 0 4 134 123 135 133
		f 4 99 220 -222 -219
		mu 0 4 136 125 137 124
		f 4 119 222 -224 -221
		mu 0 4 138 127 139 126
		f 4 139 224 -226 -223
		mu 0 4 140 129 141 128
		f 4 159 226 -228 -225
		mu 0 4 142 131 143 130
		f 4 -158 228 227 -230
		mu 0 4 95 84 130 143
		f 4 -118 230 223 -232
		mu 0 4 73 62 126 139
		f 4 -78 232 219 -234
		mu 0 4 51 40 133 135
		f 4 -58 234 217 -233
		mu 0 4 40 29 121 133
		f 4 -98 233 221 -231
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "89FB41CE-48FF-6D06-3E08-0F92496008C9";
	setAttr -s 9 ".lnk";
	setAttr -s 9 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9E5732C5-4F0B-8135-1CB1-DCA09768AE7C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FC8A5184-43F8-AC29-34BC-BFB3810D78E1";
createNode displayLayerManager -n "layerManager";
	rename -uid "87757A67-4B9E-8E30-9D07-98BB35DACBA5";
createNode displayLayer -n "defaultLayer";
	rename -uid "368A0E0F-46BD-3F33-8402-BEBDB84D6DF6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DD5F38DE-44DA-EB26-7CC1-8FB96BA4EEB2";
