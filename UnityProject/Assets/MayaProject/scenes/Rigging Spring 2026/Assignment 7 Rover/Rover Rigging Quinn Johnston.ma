...
//Last modified: Tue, Mar 10, 2026 06:17:43 PM
//Codeset: 1252
...
fileInfo "UUID" "C45E5C82-497C-91A2-9AF6-80AEE906C266";
createNode transform -s -n "persp";
	rename -uid "38B2B9F8-4508-4727-92D2-16A0255712A3";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -193.91941565433993 222.89819246407527 286.86187761735965 ;
	setAttr ".r" -type "double3" -25.53835272884881 -5432.9999999863921 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "71C80292-4324-A4ED-5CD6-B99F78D0734F";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 394.19544353642897;
...
createNode joint -n "R_Wheels_arm" -p "TRANSFORM";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 89.999999999999091 80.714688021949598 -90.000000000000952 ;
...
createNode joint -n "R_Mid_Wheel_Pivot" -p "R_Back_Wheels_arm";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 179.99999829245269 -3.2278118984102465e-14 90.000000000000043 ;
	setAttr ".radi" 0.95688703767526784;
...
createNode joint -n "R_Front_Panel" -p "TRANSFORM";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" -0.38461833085398284 -34.35782954808051 0.21706525245349809 ;
	setAttr ".radi" 2;
...
createNode fosterParent -n "rover_modelRNfosterParent1";
	rename -uid "E49AC212-41A2-5B4D-7D61-9F8E98EE8E40";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EAB16DA9-4C08-1F72-2EB8-AFA1B29CC564";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "8FE1DB27-45E9-0E08-5498-E3BF1E7CC885";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E642D0CE-48CB-E8E0-9B19-33985BC73E39";
createNode displayLayerManager -n "layerManager";
	rename -uid "E1FE35C3-4FB2-413E-CC18-329FCFF45553";
	setAttr ".cdl" 3;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B283523D-41DF-DDC4-BA01-0CBAD2FC1535";
