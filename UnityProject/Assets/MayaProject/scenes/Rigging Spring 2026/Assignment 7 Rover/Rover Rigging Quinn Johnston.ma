...
//Last modified: Tue, Mar 10, 2026 06:04:01 PM
//Codeset: 1252
...
fileInfo "UUID" "B314C8E1-497E-B632-0E07-93A263BAD7A8";
createNode transform -s -n "persp";
	rename -uid "38B2B9F8-4508-4727-92D2-16A0255712A3";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -313.28153254884847 161.08333783996613 -45.987350311349672 ;
	setAttr ".r" -type "double3" -21.338352729557304 -4422.1999999984937 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "71C80292-4324-A4ED-5CD6-B99F78D0734F";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 350.21351922772851;
...
createNode joint -n "camera_arm_end_rotate" -p "Camera_arm_Upper_arm";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 6.4699264954078593e-14 -4.8436546059085868e-14 119.99995339682107 ;
...
createNode fosterParent -n "rover_modelRNfosterParent1";
	rename -uid "581B0C0D-42EE-6654-A868-6692709820F6";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "151E614D-4AD5-45E4-05F9-4DBC76F1BEF6";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0573DCAC-4DCD-E4E0-5436-16A96366E576";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "611DECE1-444F-4170-9382-759ABB74433B";
createNode displayLayerManager -n "layerManager";
	rename -uid "4D98DC22-4410-9674-9071-50AB58DAF368";
	setAttr ".cdl" 2;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F09E97B1-4308-2506-2BBB-F2B75AF4CFE7";
